...
def routine(processing_device="GPU", visualize=False, deterministic=False):
    ...
    logging.info(f"""
        A rede neural usada nos testes possui:
    ...
    test_agent(trading_env, agent, 
               test_df, test_df_nomalized, 
               visualize=True, test_episodes=10, 
               folder="/home/douglasnacl/runs/2023_01_22_19_05_ddqn_trader", name="ddqn_trader", 
               comment="", 
               display_reward=False, display_indicators=False)